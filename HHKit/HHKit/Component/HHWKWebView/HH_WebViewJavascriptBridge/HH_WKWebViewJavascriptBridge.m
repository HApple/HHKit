...
#import "HH_WKWebViewJavascriptBridge.h"

#if defined supportsWKWebView

@implementation HH_WKWebViewJavascriptBridge {
    __weak WKWebView* _webView;
    __weak id<WKNavigationDelegate> _webViewDelegate;
    long _uniqueId;
    HH_WebViewJavascriptBridgeBase *_base;
}

/* API
 *****/

+ (void)enableLogging { [HH_WebViewJavascriptBridgeBase enableLogging]; }

+ (instancetype)bridgeForWebView:(WKWebView*)webView {
    HH_WKWebViewJavascriptBridge* bridge = [[self alloc] init];
...
- (void)send:(id)data responseCallback:(HH_WVJBResponseCallback)responseCallback {
...
- (void)callHandler:(NSString *)handlerName data:(id)data responseCallback:(HH_WVJBResponseCallback)responseCallback {
    [_base sendData:data responseCallback:responseCallback handlerName:handlerName];
}

- (void)registerHandler:(NSString *)handlerName handler:(HH_WVJBHandler)handler {
...
- (void) _setupInstance:(WKWebView*)webView {
    ...
    _base = [[HH_WebViewJavascriptBridgeBase alloc] init];
    _base.delegate = self;
}
